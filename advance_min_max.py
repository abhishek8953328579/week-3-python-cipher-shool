...
# print(max(numbers))
names=["Abhishek maurya","Aman","navelsh","medhansh","ab","ahshshshshsshhshhsh"]
...
dict1={
    "Abhishek maurya":{"math":99,"science":78},
    "aman":{"math":200,"science":100},
    "raju kumar":{"math":45,"science":56},
    "medhansh":{"math":56,"science":55},
